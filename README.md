...
## 2. Create a relational database and add the data
...
### 2.2. Add the Pagila tables to the PostgreSQL default database
...
## 3. Query the database using a Jupyter notebook
...
### 3.1. Ensure your notebooks are using your virtual environment packages by making them available as a kernel
...
### 3.2. Ensure your notebook has the ability to benchmark queries
...
### 3.3. Fire up your notebook and select your kernel
...
## 4.1. A note on flushing the cache (creating "cold client, cold server" conditions)
...
## 4.2. `pd.read_sql():` Direct SQL performance
...
## 4.3. What about subsequent re-runs of the same query (creating "warm client, warm server" conditions)?
...
### 5.4. Use the data package directly from a notebook (create "cold client, cold server" conditions)
...
### 5.5. What about subsequent re-runs of the same data import (creating "warm client, warm server" conditions)?
...
### 5.6. Summary of direct SQL queries using Pandas vs. Quilt data package
